  ...
  return (
    <>
      ...
      <div className="grid grid-cols-6 lg:grid-cols-12 gap-6">
            ...
            <RowGridText text="Vendor Performance Audit" />
            ...
            />
             <Input
                ...
                value={formData.CriteresDeRealisationDeLaQualite}
            />
             <RowGridText text="Procurement Management Process Audit" />

             <RowGridText text="Plan Procurements" small />
               <TextField
                   className="xl:col-span-3"
                   isLoading={false}
                   lable="Followed"
               ...
               <TextField
                  ...
                  isLoading={false}
                  lable="Tools and Techniques Used"
                  onChange={(e) => setFormData({...formData , CriteresDeRealisationDeLaQualite : e.target.value})}
                  value={formData.CriteresDeRealisationDeLaQualite}
                />

                  
             <RowGridText text="Conduct Procurements" small />
               <TextField
                   className="xl:col-span-3"
                   isLoading={false}
                   lable="Followed"
             ...
             <RowGridText text="Administer Procurements" small />
               <TextField
                   className="xl:col-span-3"
                   isLoading={false}
                   lable="Followed"
