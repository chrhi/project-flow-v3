...
export  function OtherAdd ({refetch } : Props) {
    ...
    const [formData , setFormData] = useState({
        AREAS_OF_EXCEPTIONAL_PERFORMANCE : "" ,
        ...
        <Dialog as="div" className="relative z-[100]" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
           ...
           <div className="bg-white p-4  w-full  ">
            ...
            <TextField
              lable='AREAS OF EXCEPTIONAL PERFORMANCE'
              value={formData.AREAS_OF_EXCEPTIONAL_PERFORMANCE}
              onChange={(e) => setFormData({...formData , AREAS_OF_EXCEPTIONAL_PERFORMANCE : e.target.value})}
            />
