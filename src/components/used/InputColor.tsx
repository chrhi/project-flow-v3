...
export  const ColorNumber = ({lable , value , onChange , type  , lableClassName , isLoading, inputClassName ,className  , ...PropsType}:PropsType) => {
  return (
   <>
      {
        isLoading ?  
       <div className="col-span-6 ">
        ...
        <div  className={`col-span-6  ${className ? className : ""}`}>
           ...
           <input {...PropsType} onChange={onChange} type='color'  name={lable} id={lable + "id"} value={value}
